...
class BGPSessionMetricsDataSource:
    ''' BGP Session Metrics data provider
    '''
    ...
    def metric_records(router_entry, *, metric_labels=None):
        ...
        try:
            ...
            print(f'Error getting BGP info from router{router_entry.router_name}@{router_entry.config_entry.hostname}: {exc}')
            return None